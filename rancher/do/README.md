...
| <a name="input_elemental_operator_version"></a> [elemental\_operator\_version](#input\_elemental\_operator\_version) | Version of Elemental Operator to install | `string` | `"stable"` | no |
